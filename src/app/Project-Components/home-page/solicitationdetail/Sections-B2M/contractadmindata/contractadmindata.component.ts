...
@Component({
  selector: 'app-contractadmindata',
  templateUrl: './contractadmindata.component.html',
  styleUrls: ['./contractadmindata.component.css']
})
export class ContractadmindataComponent implements OnInit {
