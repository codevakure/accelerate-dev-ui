...
@Component({
  selector: 'app-packagingandmarketing',
  templateUrl: './packagingandmarketing.component.html',
  styleUrls: ['./packagingandmarketing.component.css']
})
export class PackagingandmarketingComponent implements OnInit {
